...
```javascript
isNonNegativeNumber = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-nonnegative-number@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-nonnegative-number@v0.2.2-umd/browser.js"></script>
```
...
[@stdlib/assert/is-nonnegative-finite]: https://github.com/stdlib-js/assert-is-nonnegative-finite/tree/umd
